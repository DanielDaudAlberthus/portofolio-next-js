...
async function GET() {
    ...
    return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(projects.map((p)=>({
            ...p,
...
async function PUT(req) {
    const data = await req.json();
    const { id, ...rest } = data;
    const project = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].project.update({
        where: {
            id
        },
        data: {
...
async function DELETE(req) {
    ...
    await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].project.delete({
        where: {
            id
        }
    });
...
//# sourceMappingURL=%5Broot-of-the-server%5D__fe81ad18._.js.map